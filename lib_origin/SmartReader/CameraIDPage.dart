...
import '../vision_detector_views/text_smart_card_view.dart';
import '../vision_detector_views/text_smart_card_tesscract_view.dart';
import '../vision_detector_views/text_from_widget_view.dart';

class ThaiIDScannerPage extends StatefulWidget {
  const ThaiIDScannerPage({super.key});

  @override
  State<ThaiIDScannerPage> createState() => _ThaiIDScannerPageState();
}

class _ThaiIDScannerPageState extends State<ThaiIDScannerPage> {
    @override
                ...
                children: [
                  ExpansionTile(
                    ...
                    children: [
                      ...
                      CustomCard('Text SmartCard', TextSmartCardView()),
                      CustomCard('Text SmartCard (Tesseract)', ThaiIdYoloScanner()),
