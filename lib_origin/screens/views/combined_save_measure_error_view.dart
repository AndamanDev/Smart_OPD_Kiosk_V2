...
class CombinedSaveMeasureErrorView extends StatefulWidget {
  const CombinedSaveMeasureErrorView({super.key});

  @override
  State<CombinedSaveMeasureErrorView> createState() =>
      _CombinedSaveMeasureErrorViewState();
}

class _CombinedSaveMeasureErrorViewState
    extends State<CombinedSaveMeasureErrorView> {
  @override
  void initState() {
    super.initState();
